				...
				<div class='landing-con-left content-expand '>
					<div class="landing-con-container scale-content-txt-1 fade-in-onload">
						...
						<div class='landing-tx1-heading pulsate'>
							<h1>Игры<br>
							 Каргапольцев Савелий</h1>
						</div>
						<div class='landing-tx2-heading'>
							<p>
								 Данная проектная работа является примерочной.
							</p>
				...
				<div class="search-con-inner">
					<div class="search-inp-search darkmode-search-border">
						...
						<div class="search-con-author darkmode-txt">
							<span class="darkmode-txt"><span class="search-img-author"></span>
							<span class="search-tx1-author"></span>
							</span>
							</a>
						</div>
						<form action='/compatibility' method='get'>
							<input class="database-search darkmode-txt darkmode-search-bg" name="g" placeholder="Сюда можно написать желание и через 10 часов 13 минут оно сбудется">
						</form>
					</div>
				</div>
			</div>
					...
					<div class="discord-con-mantra">
						<div class="discord-wrp-mantra scale-content-txt-1">
							...
							<div class="discord-tx2-mantra darkmode-txt">
								<p>
									 Не знаю к чему в принципе эта информация, но у меня есть общий с друзьями дискорд канал, где мы общаемся.
								</p>
							</div>
							<a href="https://discord.gg/PJgx7Tjh" target="_blank">
							<div class="discord-btn-button">
								<div class="discord-ico-button">
								</div>
								<div class="discord-tx1-button">
									<span>Зайти посмотреть</span>
								</div>
							</div>
							</a>
						</div>
